...
public class OldOscillator extends AudioInputStream
{
    ...
    public OldOscillator(int nWaveformType, float fSignalFrequency,
                         float fAmplitude, AudioFormat audioFormat, long lLength)
    {
        ...
        if (DEBUG) { out("andts.javasynth.oscillator.OldOscillator.<init>(): begin"); }
    ...
    public int read()
            throws IOException
    {
        if (DEBUG) { out("andts.javasynth.oscillator.OldOscillator.read(): begin"); }
            ...
            throws IOException
    {
        ...
        if (DEBUG) { out("andts.javasynth.oscillator.OldOscillator.read(): end"); }
        return nReturn;
    }
...
/*** andts.javasynth.oscillator.OldOscillator.java ***/